  ...
  useEffect(() => {
    const fetchPopImages = async () => {
      try {
        ...
        setError(err.message || 'Failed to load Pop Art images');
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className='h-screen w-screen overflow-x-hidden bg-gray-100 dark:bg-gray-900 font-Playfair'>
      ...
      <div className='h-[80vh] w-full bg-center bg-cover' style={{ backgroundImage: `url(${BackImg})` }}>
        ...
        <h1 className='font-Tapestary text-[30px] md:text-[50px] text-pink-600 drop-shadow-lg animate-fade-in'>Color Meets Culture</h1>
<h5 className='font-Carattere text-[20px] md:text-[28px] text-yellow-400 mt-4 drop-shadow-md animate-fade-in delay-200'>
  Dive into the vibrant world of pop art—where pop culture, irony, and bold graphics collide in playful rebellion.
</h5>
      ...
      {/* Content Section */}
      <section ref={contentRef} className='lg:w-[85%] w-[96%] py-4 mx-auto bg-gray-100 dark:bg-gray-900'>
       <div className='max-w-7xl mx-auto text-center'>
  <h2 className='text-2xl md:text-3xl font-bold font-Quicksand text-gray-800 dark:text-gray-200 mb-4'>Jump into the Colorful World of Pop Art</h2>
  <p className='text-base md:text-lg text-gray-600 dark:text-gray-300'>
    Pop Art turns everyday culture into bold, exciting visuals. Explore works that celebrate icons, irony, and bright rebellion.
  </p>
</div>
</section>
        {/* The divider section */}
