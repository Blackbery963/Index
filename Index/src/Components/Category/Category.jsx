...
function Category() {
  ...
  const baseCategories = [
    { name: "Landscape", para: "Natural scenery emphasizing light, mood, and atmosphere.", link: "/Landscape" },
    { name: "Portrait", para: "Capturing personality, expression, and likeness of a person.", link: "/Portrait" },
    { name: "Watercolor", para: "Transparent pigments mixed with water producing soft effects.", link: "/Watercolor" },
    { name: "Oil Painting", para: "Rich textures and vibrant colors with slow blending.", link: "/Oil_Paint" },
    { name: "Abstract", para: "Expressing ideas through colors, shapes, and forms.", link: "/abstract" },
    { name: "Still Life", para: "Inanimate objects emphasizing composition and lighting.", link: "/Still-Life" },
    { name: "Historical Art", para: "Depicting significant events or figures from history.", link: "/Historical" },
    { name: "Surrealism", para: "Blends reality and dreams with symbolic elements.", link: "/Surrealism" },
    { name: "Impressionism", para: "Fleeting moments with quick brushstrokes and bright colors.", link: "/Impressionism" },
    { name: "Realism", para: "Portrays subjects truthfully and accurately.", link: "/Realism" },
    { name: "Expressionism", para: "Vivid colors and dramatic distortions for emotions.", link: "/Expressionism" },
    { name: "Minimalism", para: "Simplifies composition using basic shapes and limited colors.", link: "/Minimalism" },
    { name: "Pop Art", para: "Bold colors and imagery from mass culture.", link: "/Pop-Art" },
    { name: "Nature", para: "Showcases the beauty of the natural world.", link: "/Nature" },
    { name: "Traditional", para: "Represents cultural and heritage-based art forms.", link: "/Traditional" },
    { name: "Digital", para: "Created using modern digital tools and techniques.", link: "/Digital" },
    { name: "Modern", para: "Breaks away from classical forms with innovation.", link: "/Modern" },
    { name: "Photography", para: "Capturing light and moments with visual expression.", link: "/Photography" },
  ];
