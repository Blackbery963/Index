...
const StoryLikeButton = ({
  ...
  const [localIsLiked, setLocalIsLiked] = useState(initialLikes || false); // Use prop if available
  ...
  useEffect(() => {
  const likedStories = JSON.parse(localStorage.getItem('likedStories') || '[]');
  const isLiked = initialLikes || likedStories.includes(storyId);
  setLocalIsLiked(isLiked);
}, [storyId, initialLikes]); // Add initialIsLiked to dependencies
