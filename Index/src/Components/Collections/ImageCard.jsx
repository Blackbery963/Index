...
//   const likeCount = image.likes + (isLiked ? 1 : 0);
...
//             className="bg-white dark:bg-gray-900 rounded-sm shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-200/50 dark:border-gray-700/50 group cursor-pointer"
//             onClick={handleClick}
//           >
