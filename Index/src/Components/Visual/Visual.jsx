...
// import { FiSearch, FiFilter, FiHeart, FiShoppingCart, FiChevronDown, FiX, FiArrowRight } from 'react-icons/fi';
...
//         }
//       `}</style>
//       <div className="relative w-full h-64 -mt-32 overflow-hidden">
//   {/* Fog Effect */}
//   <div className="absolute inset-0 bg-gradient-to-t from-gray-100 dark:from-[#040d12] via-transparent to-transparent z-10"></div>
//   {/* <div className="absolute inset-0 bg-[url('https://assets.codepen.io/13471/smoke-1.png')] opacity-20 dark:opacity-10 animate-fog"></div> */}
  
//   {/* Explore More Button */}
//   <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 z-20 text-center">
//     <motion.button
//       className="px-8 py-3 bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-full shadow-lg font-medium hover:shadow-xl transition-all duration-300 group"
//       whileHover={{ scale: 1.05 }}
//       whileTap={{ scale: 0.95 }}
//     >
...
//       </span>
//       <span className="absolute inset-0 bg-gradient-to-r from-amber-600 to-amber-700 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
//     </motion.button>
//   </div>
// </div>
//     </div>
...
//         <h1 className="text-5xl md:text-7xl font-light text-black tracking-tight mb-4">
//           Curated
//         </h1>
...
//             >
//               <div className="relative overflow-hidden aspect-square rounded-lg bg-gray-50">
//                 <img
//                   src={item.image}
//                   alt={item.title}
...
//                   hoveredItem === item.id ? 'opacity-10' : 'opacity-0'
//                 }`} />
...
//               {/* Bottom Info */}
//               <div className={`pt-4 transition-opacity duration-300 ${
//                 hoveredItem === item.id ? 'opacity-0' : 'opacity-100'
//               }`}>
//                 <div className="text-xs uppercase tracking-wider text-gray-400 mb-1">
//                   {item.category}
//                 </div>
//                 <h3 className="text-lg font-light text-black mb-1">{item.title}</h3>
...
//         <button className="group relative overflow-hidden px-8 py-3 border border-black text-black hover:text-white transition-colors duration-300">
//           <span className="relative z-10 text-sm uppercase tracking-wider font-light">
//             Explore Collection
//           </span>
//           <div className="absolute inset-0 bg-black transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-in-out" />
//         </button>
//       </div>
//     </div>
//   );
