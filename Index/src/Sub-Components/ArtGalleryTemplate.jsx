...
// Gallery configurations - Add more galleries here
const GALLERY_CONFIGS = {
  digital: {
    ...
    contentTitle: 'Dive into the World of Digital Art',
    contentDescription: 'Witness creativity without limits. Digital art fuses imagination and technology to create vivid, boundary-pushing masterpieces.',
    searchPlaceholder: 'Search Digital...',
    infoCards: 'digital'
  },
  abstract: {
    tag: 'Abstract',
    backgroundImage:'https://images.pexels.com/photos/2377473/pexels-photo-2377473.jpeg',
    ...
    contentTitle: 'Echoes of the Mind – The Unspoken Language of Abstract Art',
    contentDescription: 'With every stroke and vibrant hue, each piece beckons you to journey into the depths of emotion, where imagination knows no bounds and meaning is shaped by the viewer\'s soul.',
    searchPlaceholder: 'Search Abstract...',
    infoCards: 'Abstract'
  },
  landscape: {
    tag: 'Landscape',
    ...
    subtitle: 'Explore breathtaking vistas and serene landscapes captured through the artist\'s lens',
    contentTitle: 'Journey Through Natural Beauty',
    contentDescription: 'Immerse yourself in stunning landscapes that capture the essence of nature\'s grandeur and tranquility.',
    searchPlaceholder: 'Search Landscape...',
    infoCards: 'landscape'
  },
  portrait: {
    tag: 'Portrait',
    ...
    title: 'Faces & Stories',
    subtitle: 'Discover the art of human expression through captivating portraits',
    contentTitle: 'The Human Connection',
    contentDescription: 'Each portrait tells a unique story, capturing emotions, personalities, and the essence of humanity.',
    searchPlaceholder: 'Search Portrait...',
    infoCards: 'portrait'
  },
  traditional: {
    tag: 'Traditional',
    backgroundImage: './Sub_components_images/traditional.jpg',
    title: 'Timeless Traditions',
    subtitle: 'Experience the beauty of classical art techniques and traditional mediums',
    contentTitle: 'Heritage in Every Stroke',
    contentDescription: 'Celebrate the rich history of traditional art forms that have shaped the world of creativity.',
    searchPlaceholder: 'Search Traditional...',
    infoCards: 'traditional'
  }
  // Add more gallery types here as needed
};

function ArtGalleryTemplate() {
  const { galleryType } = useParams();
  const config = GALLERY_CONFIGS[galleryType] || GALLERY_CONFIGS.digital;
  ...
  // Fetch images based on gallery type
  useEffect(() => {
    const fetchImages = async () => {
      try {
        ...
        setError(err.message || `Failed to load ${galleryType} images`);
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className='h-screen w-screen overflow-x-hidden bg-gray-100 dark:bg-gray-900 font-Playfair'>
      ...
      <div className='h-[80vh] w-full bg-center bg-cover' style={{ backgroundImage: `url(${config.backgroundImage})` }}>
        ...
        <main className='flex flex-col items-center justify-center h-full px-4 text-center'>
          <h1 className='font-Tapestary text-[30px] md:text-[50px] text-blue-600 drop-shadow-lg animate-fade-in'>
            {config.title}
          </h1>
          <h5 className='font-Carattere text-[20px] md:text-[28px] text-cyan-300 mt-4 drop-shadow-md animate-fade-in delay-200'>
            {config.subtitle}
          </h5>
          <button 
            ...
            >
              ...
              >
                <img
                  ...
                  alt={images[lightbox.index].title || 'Artwork'}
...
export default ArtGalleryTemplate;