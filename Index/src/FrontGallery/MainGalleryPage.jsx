...
//         pageSize: 12 // Smaller page size for better performance
//       });
...
//       loadMedia(activeFilter, nextPage, false);
//     }
//   };
...
//   return (
//     <div className="min-h-screen bg-gray-50 dark:bg-gray-900 max-w-7xl mx-auto">
//       {/* Header with Filters */}
...
//                 Page {currentPage} • {media.length} items
...
//       {/* Main Content - Remove lastElementRef since we're not using infinite scroll */}
//       <CollectionContent
//         error={error}
//         loading={loading}
//         images={media}
...
//         lastElementRef={null} // Remove infinite scroll reference
//       />
//     </div>
//   );
// };
...
//   return (
//     <div className="min-h-screen bg-gray-100 dark:bg-[#000705] max-w-7xl mx-auto"> 
//       {/* Main Content - Remove lastElementRef since we're not using infinite scroll */}
//       <CollectionContent
//         error={error}
//         loading={loading}
...
const MainGalleryPage = ({ 
  ...
  // If integrated into ImprovedCollection, just return the content without header
  // if (onFilterChange && onViewModeChange) {
  //   return (
  //     <CollectionContent
  //       error={error}
  //       loading={loading}
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-[#000705] mt-4">
