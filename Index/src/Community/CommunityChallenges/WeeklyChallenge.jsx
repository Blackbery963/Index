...
function WeeklyChallenge() {
  ...
  // Sample data for weekly challenges with Pexels images
  const challenges = {
    current: {
      title: "Urban Sketch",
      description: "Capture the vibrancy of city life in a quick sketch. From bustling streets to quiet corners, show us your urban perspective!",
      deadline: "July 30, 2025",
      prize: "$200 + Digital Art Feature",
      participants: 856,
      topSubmissions: [
        {
          id: 1,
    ...
    upcoming: {
      title: "Nature Snap",
      description: "Get ready to sketch the beauty of nature in a quick challenge. Think forests, rivers, or wildlife in their natural habitat.",
      deadline: "Starts August 1, 2025",
      prize: "$200 + Art Tool Voucher",
      image: "https://images.pexels.com/photos/807598/pexels-photo-807598.jpeg"
    },
    past: [
      {
        id: 1,
        title: "Portrait Pulse",
        winner: "Noah Evans",
      ...
      },
      {
        ...
        title: "Abstract Wave",
        winner: "Luna Chen",
        image: "https://images.pexels.com/photos/2387966/pexels-photo-2387966.jpeg"
      },
      {
        id: 3,
    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 pb-24 font-Playfair">
      ...
      >
        <div className="px-6 py-4 flex items-center justify-between ">
          ...
          <button
            className="md:hidden text-gray-700 dark:text-gray-200 items-center"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto font-Playfair">
            Quick, creative challenges to spark your inspiration and showcase your skills!
          </p>
        </motion.div>
