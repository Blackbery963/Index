    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 pb-24 font-Playfair">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
        ...
        <div className="flex justify-center mb-12">
          <div className="inline-flex overflow-x-auto rounded-xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg p-1.5 shadow-lg">
            {['current', 'upcoming', 'past'].map((tab) => (
              <button
                key={tab}
                onClick={() => setActiveTab(tab)}
                className={`px-6 py-3 whitespace-nowrap rounded-lg font-semibold text-lg transition-all duration-300 ${
                  activeTab === tab 
