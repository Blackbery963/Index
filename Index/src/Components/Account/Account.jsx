 ...
 if (loading) {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col pb-6 overflow-x-hidden bg-gray-50 dark:bg-gray-900">
      ...
      {/* Floating Header */}
      <header className="w-full py-4 bg-white/40 dark:bg-gray-800/80 backdrop-blur-md flex items-center justify-between px-6 z-50 fixed border-b border-gray-200 dark:border-gray-700">
